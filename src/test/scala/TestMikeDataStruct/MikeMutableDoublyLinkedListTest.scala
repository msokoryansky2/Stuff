...
class MikeMutableDoublyLinkedListTest extends FunSuite {
  test("Can peek, push, pop, peekLast, pushLast, and popLast. Can keep track length along the way and check if value is present") {
    ...
    assert(l.toString2 === "4 <-> 3 <-> 2 <-> 1 <-> 0 <-> -1")
    assert(l.contains(0) === true)
    assert(l.contains(1) === true)
    assert(l.contains(2) === true)
    assert(l.contains(1000) === false)
    ...
    l.pushLast(1000)
    assert(l.peek === Some(2))
    assert(l.peekLast === Some(1000))
    assert(l.length === 5)
    assert(l.toString === "2 <-> 1 <-> 0 <-> -1 <-> 1000")
    assert(l.toString2 === "2 <-> 1 <-> 0 <-> -1 <-> 1000")
    assert(l.contains(0) === true)
    assert(l.contains(1) === true)
    assert(l.contains(2) === true)
    assert(l.contains(1000) === true)

    assert(l.popLast === Some(1000))
    assert(l.peek === Some(2))
    assert(l.peekLast === Some(-1))
    assert(l.length === 4)
    assert(l.toString === "2 <-> 1 <-> 0 <-> -1")
  ...
  test("insertBefore and remove allow insertion and removal from any place in the list") {
    ...
    assert(l.toString2 === "-1 <-> 0 <-> -2 <-> 2 <-> 3 <-> 1")
    assert(l.contains(0) === true)
    assert(l.contains(1) === true)
    assert(l.contains(2) === true)
    assert(l.contains(1000) === false)
    ...
    assert(l.length === 4)
    assert(l.toString === "-1 <-> 0 <-> 2 <-> 3")
    assert(l.toString2 === "-1 <-> 0 <-> 2 <-> 3")
    assert(l.contains(0) === true)
    assert(l.contains(1) === false)
    assert(l.contains(2) === true)
    assert(l.contains(1000) === false)
  ...
  test("reverse reverses the list") {
    ...
    assert(l.toString2 === "1 <-> 2")

    l.push(3)
    assert(l.toString === "3 <-> 1 <-> 2")
    assert(l.toString2 === "3 <-> 1 <-> 2")
    l.reverse()
    assert(l.toString === "2 <-> 1 <-> 3")
    assert(l.toString2 === "2 <-> 1 <-> 3")

    l.insertBefore(4, 1)
    assert(l.toString === "2 <-> 4 <-> 1 <-> 3")
    assert(l.toString2 === "2 <-> 4 <-> 1 <-> 3")
    l.reverse()
    assert(l.toString === "3 <-> 1 <-> 4 <-> 2")
    assert(l.toString2 === "3 <-> 1 <-> 4 <-> 2")

    assert(l.pop === Some(3))
    assert(l.toString === "1 <-> 4 <-> 2")
    assert(l.toString2 === "1 <-> 4 <-> 2")
    l.reverse()
    assert(l.toString === "2 <-> 4 <-> 1")
    assert(l.toString2 === "2 <-> 4 <-> 1")

    assert(l.pop === Some(2))
    assert(l.toString === "4 <-> 1")
    assert(l.toString2 === "4 <-> 1")
    l.reverse()
    assert(l.toString === "1 <-> 4")
    assert(l.toString2 === "1 <-> 4")

    assert(l.pop === Some(1))
    assert(l.toString === "4")
    assert(l.toString2 === "4")
    l.reverse()
    assert(l.toString === "4")
    assert(l.toString2 === "4")
